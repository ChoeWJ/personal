...
def convert_encoding_to_euckr(folder_path, target_encoding='euc-kr', file_extensions=['.txt', '.csv']):
        ...
        for file in files:
            ...
            try:
                ...
                if not original_encoding:
                    ...
                    original_encoding = 'utf-8'  # 기본 인코딩 지정 가능 (ISO-8859-1 등으로 변경 가능)
                ...
                print(f"🔄 {original_encoding} → {target_encoding} 변환 완료: {file_path}")
